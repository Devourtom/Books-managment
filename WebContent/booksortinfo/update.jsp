...
<body>
<%
	BooksortinfoEntity de = (BooksortinfoEntity)request.getAttribute("yyy");
%>
	<div class="container">
		<div class="main_top">
				...
				<div class="box">
					<div class="box_border">
						...
						<div class="box_center">
							<form action="${pageContext.request.contextPath }/BooksortinfoServlet?booksortinfo=upp" class="jqtransform"  method="post">
